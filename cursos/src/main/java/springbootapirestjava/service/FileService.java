package springbootapirestjava.service;
...
import springbootapirestjava.controller.FilesRestController;
import springbootapirestjava.exceptions.storage.StorageException;
import springbootapirestjava.exceptions.storage.StorageFileNotFoundException;
...
public class FileService implements StorageService{
    ...
    public FileService(@Value("${upload.root-location}") String path) {
